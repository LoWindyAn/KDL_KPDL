...
const RealTimeChart = () => {
  ...
  const { data } = useQuery({
    ...
    queryFn: async () => {
      const res = await axios.get(
        `http://localhost:8001/prices/hour?interval=${interval}`,
      );
      return res?.data;
    },
    refetchInterval: 300000, //5p
  });
  ...
  return (
    <div className="col-span-12 rounded-sm border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-defaul ">
